	...
	foreach( $slider as $slide ):
		...
		<li id="listItem_<?php echo $i ?>"  class="ui-state-default" style="margin-bottom:10px;">
			<div class="widget-content option-item" style="margin:5px; padding:5px;">
				...
				<label for="magee_custom_slider[<?php echo $i ?>][title]"><span><?php _e("Slide Title",'magee-shortcodes-pro');?> :</span><input id="magee_custom_slider[<?php echo $i ?>][title]" name="magee_custom_slider[<?php echo $i ?>][title]" value="<?php  echo stripslashes( $slide['title'] )  ?>" type="text" /></label>
				
				<label for="magee_custom_slider[<?php echo $i ?>][caption]"><span style="float:left" ><?php _e("Slide Caption",'magee-shortcodes-pro');?> :</span><textarea name="magee_custom_slider[<?php echo $i ?>][caption]" id="magee_custom_slider[<?php echo $i ?>][caption]"><?php echo stripslashes($slide['caption']) ; ?></textarea></label>
