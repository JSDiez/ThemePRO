...
SHINES ONE PAGE SMALL BUSINESS WEBSITE.",
	...
	////HOME PAGE
	   ...
	   $options[] = array('name' => '','id' => 'wrapper_start','type' => 'wrapper_start','class'=>'home-section-wrapper');
		...
		$options[] = array(	'name' => __('Video Loop', 'onetone'),	'id' => 'video_loop','std' => '1','class' => 'mini','options' => array('1'=>'yes','0'=>'no'), 'desc' => __('Choose to loop video', 'onetone'),	'type' => 'select','class'=>'section-item accordion-group-html5_video');
		$options[] = array(	'name' => __('Video Volume', 'onetone'),	'id' => 'video_volume','std' => '0.8','class' => 'mini','options' => array('0.001'=>'0','0.1'=>'0.1','0.2'=>'0.2','0.3'=>'0.3','0.4'=>'0.4','0.5'=>'0.5','0.6'=>'0.6','0.7'=>'0.7','0.8'=>'0.8','0.9'=>'0.9','1.0'=>'1.0'), 'desc' => __('Select video volume', 'onetone'), 'type' => 'select','class'=>'section-item accordion-group-html5_video');
	   ...
	   $options[] = array('name' => '','id' => 'wrapper_start','type' => 'wrapper_start','class'=>'home-section-wrapper');
		...
		$options[] = array(
		                   ...
		                   'type' => 'select',
		                   'desc' => __('Choose to set background image width as 100%(cover the section)', 'onetone'),
...
<p>Morbi rutrum, elit ac fermentum egestas, tortor ante vestibulum est, eget scelerisque nisl velit eget tellus. Fusce porta facilisis luctus. Integer neque dolor, rhoncus nec euismod eget, pharetra et tortor. Nulla id pulvinar nunc. Vestibulum auctor nisl vel lectus ullamcorper sed pellentesque dolor eleifend. Praesent lobortis magna vel diam mattis sagittis.Mauris porta odio eu risus scelerisque id facilisis ipsum dictum vitae volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pulvinar neque eu purus sollicitudin et sollicitudin dui ultricies. Maecenas cursus auctor tellus sit amet blandit. Maecenas a erat ac nibh molestie interdum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed lorem enim, ultricies sed sodales id, convallis molestie ipsum. Morbi eget dolor ligula. Vivamus accumsan rutrum nisi nec elementum. Pellentesque at nunc risus. Phasellus ullamcorper bibendum varius. Quisque quis ligula sit amet felis ornare porta. Aenean viverra lacus et mi elementum mollis. Praesent eu justo elit.</p>',
  ...
  <div>
    ...
    <ul class="magee-icon-list">
      <li><i class="fa fa-internet-explorer">&nbsp;</i> <a href="#">Mageewp.com</a></li>
			...
			$options[] = array(
						  ...
						  'desc' => __('Set number of posts display in this section', 'onetone'),
						  'type'    => 'select',
	...
	$options[] = array(
		...
		'desc' => __('Choose to set this item as featured', 'onetone'),
		'type'    => 'checkbox',
		'std' => $featured[$j-1],
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	...
	$options[] = array(
		...
		'desc' => __('Set Fontawsome icon which displays in the top', 'onetone'),
		'type'    => 'text',
		'std' => $icon[$j-1],
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	$options[] = array(
		...
		'desc' => __('Or choose to upload icon in image format', 'onetone'),
		'type'    => 'upload',
		'std' => '',
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	  ...
	  $options[] = array(
		...
		'desc' => __('Set title for this item', 'onetone'),
		'type'    => 'text',
		'std' => $title[$j-1],
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	  ...
	  $options[] = array(
		...
		'desc' => __('Set currency for price', 'onetone'),
		'type'    => 'text',
		'std' => '$',
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	  $options[] = array(
		...
		'desc' => __('Set price for the item', 'onetone'),
		'type'    => 'text',
		'std' => $price[$j-1],
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	   ...
	   $options[] = array(
		...
		'desc' => __('Set unit for price', 'onetone'),
		'type'    => 'text',
		'std' => 'year',
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	  ...
	  $options[] = array(
		...
		'desc' => __('List features of the item, one per line', 'onetone'),
		'type'    => 'textarea',
		'std' => $features[$j-1],
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	...
	$options[] = array(
		...
		'desc' => __('Set text for the button at the bottom of the pricing item', 'onetone'),
		'type'    => 'text',
		'std' => 'Buy Now',
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	$options[] = array(
		...
		'desc' => __('Set link for the button at the bottom of the pricing item', 'onetone'),
		'type'    => 'text',
		'std' => '#',
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
	);
	$options[] = array(
		...
		'class'=>'content-model-0 section-item accordion-group-section-'.$i
		  ...
		  'id' => 'section_columns_'.$i,
		  'name' => __( 'Columns', 'onetone' ),
		  'desc' => __('Set columns for posts module', 'onetone'),
		  'type'    => 'select',
		  'options' => array(2=>2,3=>3,4=>4),
		  'std' => '3',
		  'class'=>'content-model-0 section-item accordion-group-section-'.$i
...
$options[] =  array(
        ...
        'desc'       => __( 'Choose to enable page title bar in pages & posts', 'onetone' ),
        'std'         => 'yes',
        'type'        => 'select',
        'section'     => 'page_title_bar_tab_section',
        'class'       => '',
...
$options[] =  array(
        ...
        'desc'       => __( 'Upload image for page title bar background', 'onetone' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'page_title_bar_tab_section',
...
$options[] =  array(
        ...
        'desc'       => __( 'Upload image for page title bar background in retina devices', 'onetone' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'page_title_bar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Left Sidebar', 'onetone' ),
        'desc'       => __( 'Choose left sidebar for woocommerce product post', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Right Sidebar', 'onetone' ),
        'desc'       => __( 'Choose right sidebar for woocommerce product post', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Left Sidebar', 'onetone' ),
        'desc'       => __( 'Choose left sidebar for woocommerce archive page', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Right Sidebar', 'onetone' ),
        'desc'       => __( 'Choose right sidebar for woocommerce archive page', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Left Sidebar', 'onetone' ),
        'desc'       => __( 'Choose left sidebar for portfolio post', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Right Sidebar', 'onetone' ),
        'desc'       => __( 'Choose right sidebar for portfolio post', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
        ...
        'name'       => __( 'Left Sidebar', 'onetone' ),
        'desc'       => __( 'Choose left sidebar for portfolio archive page', 'onetone' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'sidebar_tab_section',
...
$options[] =  array(
 ...
 // Blog
        ...
        'desc'        => __('Choose to display full content or excerpt in blog archive pages', 'onetone'),
        'std'         => 'yes',
        'type'        => 'select',
        'class'       => '',
        'options'     => array(
